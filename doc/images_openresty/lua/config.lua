...
default_img_uri 	 = '/data/resources/default.jpg' 
default_uri_reg      = '_[0-9]+x[0-9]+[.jpg|.png|.gif|.jpeg]+' 
...
cfg = {
		{
			dir   = 'uploads',
			sizes = {'100x100>','300x300>','600x600>','1000x1000>','1920x1080>'},
			-- uri_reg  = '[.jpg|.png|.gif]+\![tiny|small|medium|large|original]+',
		},
		{	dir   = 'avatars',
			sizes = {'50x50^','80x80'},
		},
